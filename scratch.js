...
// select every double quote contents:
// 				/(["'])(?:(?=(\\?))\2.)*?\1/g


// string = noCommanCSV.replace(/\n/g, "*n")
...
// Dan Suggests:
// String 1 is normal
// String 2 is capture group, remove commas
// String 3 is String 1 + String 2


// old_no_good_comma_removal_regex = CSV.replace(/(?="*[^"]*@),(?=[^"]*")/g, '');